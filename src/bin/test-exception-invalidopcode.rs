// file:	test-exception-invalidopcode.rs
// author:	garnt
// date:	2/4/2019
// desc:	Integration test that tests invalid opcode exceptions
...
pub extern "C" fn _start() -> ! {
	...
	// who knew, there's an opcode that throws an invalid opcode
	unsafe {
        asm!("ud2")
    }
